...
num = 487547
input_filename = f"/Users/x2qpcheese/Desktop/tmpknp/csv/final{num}.csv"
chunksize = 50

es = Elasticsearch(['https://115.71.239.131:9200'], basic_auth=('elastic', 'HWH1rJdFReoOA8i-NPiy'), verify_certs=False, timeout=30, max_retries=10, retry_on_timeout=True)
